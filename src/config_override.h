...
#ifdef useWIFI
#define WIFI_SSID            "Wolke16"          // override here
#define WIFI_PASSWORD        "cats2104"      // override here
#endif

#ifdef useMQTT
#define MQTT_SERVER                "192.168.178.180" // override here
#define MQTT_SERVER_PORT           1883                    // override here
#define MQTT_USER                  "mqtt_home"       // override here
#define MQTT_PASS                  "$Glider15"   // override here
